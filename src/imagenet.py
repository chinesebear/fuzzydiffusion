...
class ImageNetSRTrain(ImageNetSR):
    ...
    def get_base(self):
        with open("/home/yang/sda/github/latent-diffusion/data/imagenet_train_hr_indices.p", "rb") as f:
...
class ImageNetSRValidation(ImageNetSR):
    ...
    def get_base(self):
        with open("/home/yang/sda/github/latent-diffusion/data/imagenet_val_hr_indices.p", "rb") as f:
            indices = pickle.load(f)
