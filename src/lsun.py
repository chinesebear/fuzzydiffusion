...
class LSUNChurchesTrain(LSUNBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file=options.base_path + "output/datasets/lsun/church_outdoor_train.txt", data_root=options.base_path + "output/datasets/lsun/churches", **kwargs)
...
class LSUNBedroomsTrain(LSUNBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file=options.base_path + "output/datasets/lsun/bedrooms_train.txt", data_root=options.base_path + "output/datasets/lsun/bedrooms", **kwargs)
...
class LSUNCatsTrain(LSUNBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file=options.base_path + "output/datasets/lsun/cat_train.txt", data_root=options.base_path + "output/datasets/lsun/cats", **kwargs)
