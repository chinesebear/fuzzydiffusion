...
def celeba_hq_train(config_path, delegate_path, rule_num):
    setup_seed(10)
    batch_size = 32
    img_shape = (3,256,256)
    z_shape = (4,32,32)
...
if __name__ == '__main__':
    celeba_hq_train("/home/yang/sda/github/fuzzydiffusion/src/config/latent-diffusion/celebahq-ldm-vq-4.yaml",
