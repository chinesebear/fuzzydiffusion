...
df.to_csv("doc/csv/dfs_line.csv")
# 总样本数
N =len(df)
k = 50
# 均匀间隔索引
...
# 保存
sampled_df.to_csv('doc/csv/dfs_sampled_50.csv')
...
plt.savefig("doc/fig.line.svg", format = "svg",  transparent=True,dpi=600)
plt.savefig("doc/fig.line.jpg", format = "jpg",  transparent=True,dpi=600)